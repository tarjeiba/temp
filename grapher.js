...
export function createAnalyzerTimePlotq(position) {
  const svgns = "http://www.w3.org/2000/svg";
  ...
  constructor(id, caption) {
    ...
    const controlPanels = Array.from(
      (_a =
        el === null || el === void 0
          ? void 0
          : el.getElementsByClassName("controlpanel")) !== null && _a !== void 0
        ? _a
        : []
    );
  ...
  updateFrequency(value) {
    this.markers.forEach((marker) => {
      ...
      marker.setAttribute(
        "cy",
        String(
          (_a = waveforms["sine"](value, Number(marker.getAttribute("cx")))) !==
            null && _a !== void 0
            ? _a
            : 0 * 50
        )
