...
class Graph {
    ...
    update() {
        this.markers.forEach((marker) => {
            var _a;
            marker.setAttribute("cy", String((_a = waveforms["sine"](this.amplitude, this.frequency, Number(marker.getAttribute("cx")))) !== null && _a !== void 0 ? _a : 0 * 50));
        });
    }
